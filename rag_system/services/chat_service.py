...
class ChatService:
        ...
        def list_sessions(self) -> Dict [str, Any]:
               sessions = self._sessions_store.list_sessions()
        ...
        def process_openai_completation(
                      self,
               ...
               #Approxximate token count for compatibility payload
        ...
        def get_strategies(self) -> Dict[str, Any]:
               ...
               for strategy in RetrievalStrategy:
                      items.append(
                             {
                                    "id": strategy.value,
                                    "name": strategy.value.replace("-", " ").title(),
        ...
        def upload_document(self, file_storage: FileStorage) -> Dict[str, Any]:
               ...
               return {
                      ...
                      "message": "File uploaded and indexed sucesffully",
               } 
